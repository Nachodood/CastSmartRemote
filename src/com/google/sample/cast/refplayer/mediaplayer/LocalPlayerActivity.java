 ...
 */
public class LocalPlayerActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private void setupSensors() {
        ...
        m_sensorManager.registerListener(this, m_sensorGameRotation, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_settings) {
            ...
            Toast.makeText(this, " " + m_compassValue, Toast.LENGTH_SHORT).show();
        }
        return true;
    }
